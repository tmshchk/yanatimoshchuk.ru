...
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet, {
  title: title
}), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_header__WEBPACK_IMPORTED_MODULE_4__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "\u0420\u0443\u0431\u0440\u0438\u043A\u0438"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, group.map(tag => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
  key: tag.fieldValue
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_3__.Link, {
  to: `/tags/${lodash_kebabCase__WEBPACK_IMPORTED_MODULE_1___default()(tag.fieldValue)}/`
}, tag.fieldValue, " (", tag.totalCount, ")"))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_footer__WEBPACK_IMPORTED_MODULE_5__["default"], null));

TagsPage.propTypes = {
  data: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    allMdx: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
      group: prop_types__WEBPACK_IMPORTED_MODULE_6___default().arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
        fieldValue: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().string.isRequired),
        totalCount: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().number.isRequired)
      }).isRequired)
    }),
    site: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
      siteMetadata: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
